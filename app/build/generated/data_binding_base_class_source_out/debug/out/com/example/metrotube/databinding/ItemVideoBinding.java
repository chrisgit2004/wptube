...
public final class ItemVideoBinding implements ViewBinding {
  ...
  private ItemVideoBinding(@NonNull LinearLayout rootView, @NonNull TextView duration,
      @NonNull TextView meta, @NonNull ImageView thumbnail, @NonNull TextView title) {
  ...
  public static ItemVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVideoBinding((LinearLayout) rootView, duration, meta, thumbnail, title);
    }
